...
<header>
  ...
  <section>
    <div class="container">
      <h1 class="form-title">Multi Party NDA Information Collection Form</h1>
      <form action="#" method="POST" enctype="multipart/form-data" id="multiPartyNdaForm">
        ...
        <!-- Party-Specific Fields in 3 Columns -->
        <div class="form-group" style="margin-top: 30px;">
          <label>Party Names <span style="color:red;">*</span></label>
          <small class="help-text" style="display:block; margin-bottom:10px;">
            <em>Use columns to define each party's role (Disclosing / Receiving / Mutual)</em>
          </small>
          <div style="display: flex; gap: 20px;">
            <div style="flex:1; display: flex; align-items: center; gap: 8px;">
              <span class="section-subtitle" style="min-width:70px;">Party 1</span>
              <input type="text" name="party1_name" maxlength="100" placeholder="e.g., ABC Pvt Ltd" required>
            </div>
            <div style="flex:1; display: flex; align-items: center; gap: 8px;">
              <span class="section-subtitle" style="min-width:70px;">Party 2</span>
              <input type="text" name="party2_name" maxlength="100" placeholder="e.g., XYZ Corp" required>
            </div>
            <div style="flex:1; display: flex; align-items: center; gap: 8px;">
              <span class="section-subtitle" style="min-width:70px;">Party 3</span>
              <input type="text" name="party3_name" maxlength="100" placeholder="e.g., LMN LLC" required>
            </div>
          </div>
        </div>

        <div class="form-group" style="margin-top: 20px;">
          <label>Obligations of Each Party <span style="color:red;">*</span></label>
          <div style="display: flex; gap: 20px;">
            <div style="flex:1; display: flex; align-items: center; gap: 8px;">
              <span class="section-subtitle" style="min-width:70px;">Party 1</span>
              <textarea name="obligations_party1" maxlength="400" placeholder="Summarize Party 1's obligations" required></textarea>
            </div>
            <div style="flex:1; display: flex; align-items: center; gap: 8px;">
              <span class="section-subtitle" style="min-width:70px;">Party 2</span>
              <textarea name="obligations_party2" maxlength="400" placeholder="Summarize Party 2's obligations" required></textarea>
            </div>
            <div style="flex:1; display: flex; align-items: center; gap: 8px;">
              <span class="section-subtitle" style="min-width:70px;">Party 3</span>
              <textarea name="obligations_party3" maxlength="400" placeholder="Summarize Party 3's obligations" required></textarea>
            </div>
          </div>
        </div>

        <div class="form-group" style="margin-top: 20px;">
          <label>Authorized Signatory Details <span style="color:red;">*</span></label>
          <div style="display: flex; gap: 20px;">
            <div style="flex:1; display: flex; align-items: center; gap: 8px;">
              <span class="section-subtitle" style="min-width:70px;">Party 1</span>
              <textarea name="signatory_party1" maxlength="300" placeholder="Name, designation, etc." required></textarea>
            </div>
            <div style="flex:1; display: flex; align-items: center; gap: 8px;">
              <span class="section-subtitle" style="min-width:70px;">Party 2</span>
              <textarea name="signatory_party2" maxlength="300" placeholder="Name, designation, etc." required></textarea>
            </div>
            <div style="flex:1; display: flex; align-items: center; gap: 8px;">
              <span class="section-subtitle" style="min-width:70px;">Party 3</span>
              <textarea name="signatory_party3" maxlength="300" placeholder="Name, designation, etc." required></textarea>
            </div>
          </div>
        </div>

        <div class="form-group" style="margin-top: 20px;">
          <label>Signature Fields <span style="color:red;">*</span></label>
          <div style="display: flex; gap: 20px;">
            <div style="flex:1; display: flex; align-items: center; gap: 8px;">
              <span class="section-subtitle" style="min-width:70px;">Party 1</span>
              <textarea name="signature_party1" maxlength="200" placeholder="Names/titles for signature blocks" required></textarea>
            </div>
            <div style="flex:1; display: flex; align-items: center; gap: 8px;">
              <span class="section-subtitle" style="min-width:70px;">Party 2</span>
              <textarea name="signature_party2" maxlength="200" placeholder="Names/titles for signature blocks" required></textarea>
            </div>
            <div style="flex:1; display: flex; align-items: center; gap: 8px;">
              <span class="section-subtitle" style="min-width:70px;">Party 3</span>
              <textarea name="signature_party3" maxlength="200" placeholder="Names/titles for signature blocks" required></textarea>
            </div>
          </div>
        </div>
